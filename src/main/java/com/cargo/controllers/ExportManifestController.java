...
import com.cargo.business.ExportManifestRequestProcessor;
import com.cargo.form.ExportManifestForm;
import com.cargo.services.ExportManifestService;
...
public class ExportManifestController {
	...
	@Autowired
	private ExportManifestRequestProcessor exportManifestRequestProcessor;
	 ...
	 */
	@RequestMapping(value = "/exportmanifest/listshipments", method = { RequestMethod.GET, RequestMethod.POST })
	public String listFlightDetails(@ModelAttribute final ExportManifestForm exportManifestForm, Model model) {
		...
		if (exportManifestForm.getFlightnumber() != null
			...
			exportManifestRequestProcessor.requestProcessor(
					exportManifestService.getFlightByFlightNumber(exportManifestForm.getFlightnumber()),
					exportManifestForm);
		}
		model.addAttribute("exportmanifestform", exportManifestForm);
		return "exportmanifestscreen";
	}
